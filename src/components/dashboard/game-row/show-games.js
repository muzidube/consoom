...
export default function ShowGames() {
  ...
  useEffect(() => {
    axios('https://api.igdb.com/v4/games', {
      headers: {
      ...
      method: 'POST',
      body: 'fields name,rating, first_release_date, rating_count, cover;where first_release_date > 1627464120 & rating_count > 0; sort rating_count desc; limit 100'
    })
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
